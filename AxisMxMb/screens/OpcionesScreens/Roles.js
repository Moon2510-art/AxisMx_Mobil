        ...
        <View style={styles.contenedorFiltros}>
          ...
          <View style={styles.filaFiltros}>
            <TouchableOpacity style={styles.selectorFiltro}>
              <Text style={styles.textoFiltro}>Rol</Text>
        ...
        <View style={styles.contenedorLista}>
          <TarjetaRol 
            datos={{
              id: "8",
              rol: "Alumno",
              descripcion: "Alumno de la institucion"
            }} 
          />
          <TarjetaRol 
            datos={{
              id: "5",
              rol: "Maestro",
              descripcion: "Docente de la Institucion"
            }} 
          />
          <TarjetaRol 
            datos={{
              id: "7",
              rol: "Administrativo",
              descripcion: "Personal encargado de procesos admin.."
            }} 
          />
          <TarjetaRol 
            datos={{
              id: "9",
              rol: "Seguridad",
              descripcion: "Seguridad de la institucion"
            }} 
          />
        </View>
