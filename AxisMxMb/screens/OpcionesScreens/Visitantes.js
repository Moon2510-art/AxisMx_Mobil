    ...
    <SafeAreaView style={styles.contenedor}>
      <ScrollView contentContainerStyle={styles.areaScroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.encabezadoBlanco}>
          <Text style={styles.textoTitulo}>Visitantes</Text>
        ...
        <View style={styles.contenedorFiltros}>
          ...
          <View style={styles.filaFiltros}>
            <TouchableOpacity style={styles.selectorFiltro}>
              <Text style={styles.textoFiltro}>Compañía</Text>
        ...
        <View style={styles.contenedorLista}>
          <TarjetaVisitante 
            datos={{
              ...
              compania: "Proveedor Tech",
              tipoAcceso: "QR",
              descripcion: "Visita tecnica"
            }} 
          />
          <TarjetaVisitante 
            datos={{
              ...
              compania: "Empresa de limpieza SA",
              tipoAcceso: "QR",
          ...
          <TarjetaVisitante 
            datos={{
              ...
              compania: "Distribuidora Norte",
              tipoAcceso: "QR",
              descripcion: "Entrega de mercancia"
            }} 
          />
        </View>
...
const TarjetaVisitante = ({ datos }) => (
  <View style={styles.tarjetaFila}>
    <Fila label="ID" value={datos.id} />
    <Fila label="Nombre" value={datos.nombre} />
    <Fila label="Compañía" value={datos.compania} />
    <Fila label="Tipo Acceso" value={datos.tipoAcceso} />
...
const styles = StyleSheet.create({
  ...
  textoTitulo: { fontSize: 29, color: '#365563', fontFamily: "Ultra" },
